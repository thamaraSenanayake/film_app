...
import '../../const.dart';
import 'relatedMovieListner.dart';

class RelatedMovieView extends StatefulWidget {
  final Film film;
  final RelatedMovieListener listener;
  RelatedMovieView({Key key, this.film, @required this.listener}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        onTap: (){
          widget.listener.relatedMovieClick(widget.film);
        },
        child: Container(
          height: 150,
          width: 120,
